...
<html>
 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <!-- SENDE TIL  POP UP FORM (Bootstrap MODAL) -->
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> MERKE ORDRE SLUTTFAKURA SENDT </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_sluttfaktura.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="ordrenr1" id="ordrenr1" placeholder="Ordre Nr" readonly>
                            ...
                            <input type="text" name="status" value="Sluttfaktura Sendt" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datosluttfakturasendt' name='datosluttfakturasendt' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
    <h2>SLUTTFAKTURA<br><font size="3px">(Ordrer som er klare for Sluttfaktura)</font></h2>
            </div>
               ...
               include_once('../conn.php'); 
                ...
                $query = "SELECT * FROM ordre where (status = 'Montering Utført') or (status = 'Frakt Utført') or (status = 'Klar for Henting') ORDER BY `datoopprettet` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                ...
                                <td> <center><?php echo $row['sumeksmva']; ?> </center></td>
                  ...
                  echo '<td> <a href="../ordremappe/'.$row['ordrenr'].'.pdf" target="new">Last ned</a></td>';
                  } ?>
