 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> MERKE ORDRE FORSKUDD FAKTURA BETALT </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_betaltforskuddfaktura.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="ordrenr1" id="ordrenr1" placeholder="Ordre Nr" readonly>
                            ...
                            <input type="text" name="status" value="Forskudd Faktura Betalt" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datoforskuddfakturabetalt' name='datoforskuddfakturabetalt' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
               ...
               include_once('../conn.php'); 
                ...
                $query = "SELECT * FROM ordre where (status = 'Forskudd Faktura Sendt') ORDER BY `datoopprettet` ASC";
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                ...
                                <td> <center><?php echo $row['datosendtforskuddfaktura']; ?> </center></td>
