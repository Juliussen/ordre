 ...
 <div class="modal fade" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> MERK ORDRE SENDT FORSKUDD FAKTURA </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="update_sendtfaktura.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="num" name="kundenr" id="kundenr" placeholder="Kunde Nr" readonly>
                            ...
                            <input type="text" name="status" value="Forskudd Faktura Sendt" 	readonly>
                            <input type='text' value="<?php echo $date; ?>" id='datosendtforskuddfaktura' name='datosendtforskuddfaktura' readonly><br>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid">
                ...
                $query = "SELECT * FROM ordre where (status = 'Sendt Forskudd Regnskap') ORDER BY `datoopprettet` ASC";
