                ...
                <form action="update_sendprod.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="leveringskode1" id="leveringskode1" placeholder="Leveringskode" readonly> 
                            ...
                            <input type="text" name="status" value="<?php if($row['ordrenr'] == '23321'){echo "Ferdig Produsert"; }else{ echo "Sendt Produksjon";} ?>" 	readonly>
...
<!-- LEVERINGSKODE VELGER SLUTT -------------------------------------------------------->
    ...
    <div class="container-fluid" align="right"></div>
                ...
                <h2> MINE UBEHANDLEDE ORDRER - ordrer som trenger behandling</h2>
            </div>
            <div align="right">
            ...
            ?>
                        ...
                        <tbody>
                            <tr><center>
                                <td><font size="3em"> <center><?php echo $row['ordrenr']; ?> </center></font></td>
                                ...
                                <?php if($row['ordrevedlegg'] == 0){ 
                                    ...
                                    echo '<td> <a href="ordremappe/'.$row['ordrenr'].'.pdf" target="new">Se vedlegg</a></td>';
                                } ?>
                                <?php if($row['ordrevedlegg'] == 0){ 
                                    echo '<td><<--</td>';
                                    }else{
